DROP PROCEDURE export_food_list_to_xml;
/
CALL export_food_to_xml();
/
CREATE PROCEDURE export_food_list_to_xml()
--
MODIFIES SQL DATA
...
ndb_no,
concat(
--xmlstart('food xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"'),
xmlstart('food'),
xmlwrap('food-id',ndb_no),
xmlwrap('food-name',escape_xml_element_data(long_desc)),
-- Carbohydrates, By Difference, g, 205, carbohydrates-carbs_by_diff -->
xmlwrap02('carbohydrates-carbs_by_diff',ifnull(n205,0),'g','205'),
...
xmlwrap02('carbohydrates-fiber',ifnull(n291,0),'g','291'),
-- Carbohydrates, Fructose, g, 212, carbohydrates-fructose -->
xmlwrap02('carbohydrates-fructose',ifnull(n212,0),'g','212'),
-- Carbohydrates, Glucose, g, 211, carbohydrates-glucose -->
xmlwrap02('carbohydrates-glucose',ifnull(n211,0),'g','211'),
-- Carbohydrates, Glycemic Load, g, 10006, carbohydrates-glycemic_load -->
xmlwrap02('carbohydrates-glycemic_load',ifnull(0,0),'g','10006'),
-- Carbohydrates, Lactose, g, 213, carbohydrates-lactose -->
xmlwrap02('carbohydrates-lactose',ifnull(n213,0),'g','213'),
-- Carbohydrates, Starch, g, 209, carbohydrates-starch -->
xmlwrap02('carbohydrates-starch',ifnull(n209,0),'g','209'),
-- Carbohydrates, Sucrose, g, 210, carbohydrates-sucrose -->
xmlwrap02('carbohydrates-sucrose',ifnull(n210,0),'g','210'),
-- Carbohydrates, Sugars, g, 269, carbohydrates-sugars -->
xmlwrap02('carbohydrates-sugars',ifnull(n269,0),'g','269'),
-- Energy, Gross, kcal, 208, energy-gross -->
xmlwrap02('energy-gross',ifnull(n208,0),'Kcal','208'),
-- Fats, Alpha-linolenic Acid, ALA, 18:3 n-3 c,c,c, g, 851, fats-alpha_linolenic -->
--xmlwrap02('fats-alphalinolenic',ifnull(n851,0),'g','851'),
-- Fats, Alpha-linolenic Acid, ALA, 18:3 n-3, g, 619, fats-linolenic -->
xmlwrap02('fats-linolenic',ifnull(n619,0),'g','619'),
-- Fats, Cholesterol, mg, 601, fats-cholesterol -->
xmlwrap02('fats-cholesterol',ifnull(n601,0),'mg','601'),
-- Fats, Docosahexaenoic Acid, DHA, 22:6 n-3, g, 621, fats-dha -->
xmlwrap02('fats-dha',ifnull(n621,0),'g','621'),
-- Fats, Eicosapentaenoic Acid, EPA, 20:5 n-3, g, 629, fats-epa -->
xmlwrap02('fats-epa',ifnull(n629,0),'g','629'),
-- Fats, Lauric Acid, 12:0, g, 611, fats-lauric -->
xmlwrap02('fats-lauric',ifnull(n611,0),'g','611'),
-- Fats, Linoleic Acid, LA, 18:2 n-6 c,c, g, 675, fats-linoleic -->
--xmlwrap02('fats-linoleic',ifnull(n675,0),'g','675'),
-- Fats, Linoleic Acid, LA, 18:2 n-6, g, 618, fats-linoleic -->
xmlwrap02('fats-linoleic',ifnull(n618,0),'g','618'),
-- Fats, Monounsaturated Fat, MUFA, g, 645, fats-monounsaturated -->
xmlwrap02('fats-monounsaturated',ifnull(n645,0),'g','645'),
-- Fats, Myristic Acid, 14:0, g, 612, fats-myristic -->
xmlwrap02('fats-myristic',ifnull(n612,0),'g','612'),
-- Fats, Palmitic Acid, 16:0, g, 613, fats-palmitic -->
xmlwrap02('fats-palmitic',ifnull(n613,0),'g','613'),
-- Fats, Polyunsaturated Fat, PUFA, g, 646, fats-polyunsaturated -->
xmlwrap02('fats-polyunsaturated',ifnull(n646,0),'g','646'),
-- Fats, Saturated Fat, SFA, g, 606, fats-saturated -->
xmlwrap02('fats-saturated',ifnull(n606,0),'g','606'),
-- Fats, Stearic Acid, 18:0, g, 614, fats-stearic -->
xmlwrap02('fats-stearic',ifnull(n614,0),'g','614'),
-- Fats, Total Fat, g, 204, fats-total -->
xmlwrap02('fats-total',ifnull(n204,0),'g','204'),
-- Minerals, Calcium, mg, 301, minerals-calcium -->
xmlwrap02('minerals-calcium',ifnull(n301,0),'mg','301'),
-- Minerals, Copper, mg, 312, minerals-copper -->
xmlwrap02('minerals-copper',ifnull(n312,0),'mg','312'),
-- Minerals, Iron, mg, 303, minerals-iron -->
xmlwrap02('minerals-iron',ifnull(n303,0),'mg','303'),
-- Minerals, Magnesium, mg, 304, minerals-magnesium -->
xmlwrap02('minerals-magnesium',ifnull(n304,0),'mg','304'),
-- Minerals, Manganese, mg, 315, minerals-manganese -->
xmlwrap02('minerals-manganese',ifnull(n315,0),'mg','315'),
-- Minerals, Phosphorus, mg, 305, minerals-phosphorus -->
xmlwrap02('minerals-phosphorus',ifnull(n305,0),'mg','305'),
-- Minerals, Potassium, mg, 306, minerals-potassium -->
xmlwrap02('minerals-potassium',ifnull(n306,0),'mg','306'),
-- Minerals, Selenium, µg, 317, minerals-selenium -->
xmlwrap02('minerals-selenium',ifnull(n317,0),'µg','317'),
-- Minerals, Sodium, mg, 307, minerals-sodium -->
xmlwrap02('minerals-sodium',ifnull(n307,0),'mg','307'),
-- Minerals, Zinc, mg, 309, minerals-zinc -->
xmlwrap02('minerals-zinc',ifnull(n309,0),'mg','309'),
-- Other, Alcohol, g, 221, other-alcohol -->
xmlwrap02('other-alcohol',ifnull(n221,0),'g','221'),
-- Other, Cost, $, 10005, other-cost -->
xmlwrap02('other-cost',0,'$','10005'),
-- Other, Water, g, 255, other-water -->
xmlwrap02('other-water',ifnull(n255,0),'g','255'),
...
xmlwrap02('phytonutrients-caffeine',ifnull(n262,0),'mg','262'),
-- Phytonutrients, Carotene, beta, µg, 321, phytonutrients-beta_carotene -->
xmlwrap02('phytonutrients-beta_carotene',ifnull(n321,0),'µg','321'),
-- Phytonutrients, Carotenoids, mg, 10019, phytonutrients-carotenoids -->
xmlwrap02('phytonutrients-carotenoids',ifnull(n334+n337+n338,0),'mg','10019'),
...
xmlwrap02('phytonutrients-lutein_zeaxanthin',ifnull(n338,0),'µg','338'),
-- Phytonutrients, Lycopene, µg, 337, phytonutrients-lycopene -->
xmlwrap02('phytonutrients-lycopene',ifnull(n337,0),'µg','337'),
-- Phytonutrients, Phytosterols, mg, 636, phytonutrients-phytosterols -->
xmlwrap02('phytonutrients-phytosterols',ifnull(n636,0),'mg','636'),
-- Phytonutrients, Theobromine, mg, 263, phytonutrients-theobromine -->
xmlwrap02('phytonutrients-theobromine',ifnull(n263,0),'mg','263'),
...
xmlwrap02('protein-total',ifnull(n203,0),'g','203'),
-- Vitamins, A, RAE, µg, 320, vitamins-vitamin_a -->
xmlwrap02('vitamins-vitamin_a',ifnull(n320,0),'µg','320'),
-- Vitamins, B12, µg, 418, vitamins-vitamin_b12 -->
xmlwrap02('vitamins-vitamin_b12',ifnull(n418,0),'µg','418'),
-- Vitamins, B6, mg, 415, vitamins-vitamin_b6 -->
xmlwrap02('vitamins-vitamin_b6',ifnull(n415,0),'mg','415'),
-- Vitamins, C, mg, 401, vitamins-vitamin_c -->
xmlwrap02('vitamins-vitamin_c',ifnull(n401,0),'mg','401'),
-- Vitamins, Choline, mg, 421, vitamins-choline -->
xmlwrap02('vitamins-choline',ifnull(n421,0),'mg','421'),
-- Vitamins, D, µg, 328, vitamins-vitamin_d -->
xmlwrap02('vitamins-vitamin_d',ifnull(n328,0),'µg','328'),
-- Vitamins, E, mg, 323, vitamins-vitamin_e -->
xmlwrap02('vitamins-vitamin_e',ifnull(n323,0),'mg','323'),
-- Vitamins, Folate, DFE, µg, 435, vitamins-folate -->
xmlwrap02('vitamins-folate',ifnull(n435,0),'µg','435'),
-- Vitamins, K, µg, 430, vitamins-vitamin_k -->
xmlwrap02('vitamins-vitamin_k',ifnull(n430,0),'µg','430'),
-- Vitamins, Niacin, mg, 406, vitamins-niacin -->
xmlwrap02('vitamins-niacin',ifnull(n406,0),'mg','406'),
-- Vitamins, Pantothenic Acid, mg, 410, vitamins-pantothenic -->
xmlwrap02('vitamins-pantothenic_acid',ifnull(n410,0),'mg','410'),
-- Vitamins, Riboflavin, mg, 405, vitamins-riboflavin -->
xmlwrap02('vitamins-riboflavin',ifnull(n405,0),'mg','405'),
-- Vitamins, Thiamin, mg, 404, vitamins-thiamin -->
xmlwrap02('vitamins-thiamin',ifnull(n404,0),'mg','404'),
